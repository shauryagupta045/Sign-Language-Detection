...
import { login, logout, guestLogin } from "../../redux/actions/authaction";
...
const Navbar = ({ notifyMsg }) => {
  ...
  const handleGuestLogin = () => {
    dispatch(guestLogin());
    notifyMsg("success", "Continuing as Guest!");
  };
      ...
      <div className="singlang_navlinks">
        <div className="signlang_navlinks_logo">
          <a href="/" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none' }}>
            ...
            <span className="signify-logo-text">Signify</span>
          </a>
        </div>
        ...
        <div className="signlang_navlinks_container">
          ...
          {accessToken && (
            <p>
              <Link to="/saved-texts">Saved Texts</Link>
            </p>
          )}
